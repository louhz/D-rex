...
action_array=np.array([ 0.10874859 , 0.72579837 , 0.5915207 ,  0.20047922 ,-0.10519665,  0.7018196,
  0.5687065 ,  0.1718574 , -0.25099024 , 0.72093713 , 0.5652436 ,  0.16083452,
  1.7087717 ,  0.00904086 , 0.515682 ,   0.15371417],dtype=np.float64)
...
scaled_array=np.array(action_array,dtype=float)
