...
class HandEnv:
    ...
    def compute_object_contacts(self):
        ...
        for i in range(self.mj_data.ncon):
            ...
            n1 = mj.mj_id2name(self.mj_model, mj.mjtObj.mjOBJ_GEOM, g1)
            n2 = mj.mj_id2name(self.mj_model, mj.mjtObj.mjOBJ_GEOM, g2)
            if ("screwdriver" in n1) or ("screwdriver" in n2):
                contact_count += 1
...
def main():
    ...
    xml_file = "/home/haozhe/Dropbox/physics/_data/leap_hand/scene_screwdriver.xml"
    ...
    train_phase_1(model, phase1_loader, optimizer, epochs=100, device=device)
    ...
    # Save the model
    model_save_path = "screwdriver/grasp_model_with_validation_withmass_260g_40seq.pth"
