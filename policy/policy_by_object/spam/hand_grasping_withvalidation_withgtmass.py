...
def train_phase_1(model, dataloader, optimizer, epochs=100, device="cuda"):
    ...
    for epoch in range(1, epochs+1):
        ...
        for batch in dataloader:
            ...
            loss_reward = bce(pred_reward, gt_reward)*0.05

            loss_force = mse(pred_force, gt_force_initial)*0.05
...
def main():
    ...
    xml_file = "/home/haozhe/Dropbox/physics/_data/leap_hand/scene_spam.xml"
    gt_mesh_path='/home/haozhe/spam.ply'
    gt_control_path='/home/haozhe/Dropbox/imitationlearning/spam_pick_and_place/leap_batched_output.npy'
    ...
    # Save the model
    model_save_path = "spam/grasp_model_with_validation_withmass_214g.pth"
