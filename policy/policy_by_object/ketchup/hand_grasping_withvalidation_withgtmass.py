...
class HandEnv:
    ...
    def compute_object_contacts(self):
        ...
        for i in range(self.mj_data.ncon):
            ...
            n1 = mj.mj_id2name(self.mj_model, mj.mjtObj.mjOBJ_GEOM, g1)
            n2 = mj.mj_id2name(self.mj_model, mj.mjtObj.mjOBJ_GEOM, g2)
            if ("ketchup" in n1) or ("ketchup" in n2):
                contact_count += 1
...
def train_phase_1(model, dataloader, optimizer, epochs=100, device="cuda"):
    ...
    for epoch in range(1, epochs+1):
        ...
        for batch in dataloader:
            ...
            loss_reward = bce(pred_reward, gt_reward)*0.1

            loss_force = mse(pred_force, gt_force_initial)*0.1
...
def main():
    ...
    xml_file = "/home/haozhe/Dropbox/physics/_data/leap_hand/scene_ketchup.xml"
    gt_mesh_path='/home/haozhe/ketchup.ply'
    gt_control_path='/home/haozhe/Dropbox/imitationlearning/ketchup_pick_and_place/leap_batched_output.npy'
    ...
    train_phase_1(model, phase1_loader, optimizer, epochs=40, device=device)
    ...
    # Save the model
    model_save_path = "ketchup/grasp_model_with_validation_withmass_216g.pth"
