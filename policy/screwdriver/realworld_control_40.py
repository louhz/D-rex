...
# action_array=np.array([ 0.02459253 , 0.23833828 , 0.46097797,  0.36069518 , 0.07844407 , 0.389215,
#   0.4290954 ,  0.40545788 ,-0.08018204 , 0.39408228 , 0.4106296 ,  0.4390569,
#   0.370819 ,   0.58083457 ,-0.08590441 , 0.26720095 ])


# action_array=np.array([ -0.03951823 , 0.20038754 , 0.4157408  , 0.33598396 , 0.06295185 , 0.38733605,
#   0.4134865,   0.33420876 ,-0.06900435 , 0.4437264  , 0.37856114  ,0.40077817,
#   0.41260493 , 0.51254326, -0.10346966 , 0.21453361])


action_array=np.array([-0.01178991 , 0.27243155,  0.5526219  , 0.36616144 , 0.13943209,  0.41586348,
  0.5017546,   0.40797505, -0.13491832 , 0.49597222  ,0.5090433 ,  0.45892468,
  0.41822293 , 0.66349375, -0.06821626 , 0.2889305])

# old_min, old_max = -1.47, 1.47
# new_min, new_max = -1.75, 1.75

# # # Vectorized scaling:
# scaled_array = new_min + (action_array - old_min) * (new_max - new_min) / (old_max - old_min)
scaled_array=action_array
